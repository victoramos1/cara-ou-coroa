...
<p>O projeto consiste em mostrar cara ou coroa de uma moeda.</p>

<h2>Funcionalidades do projeto</h2>

<p>O projeto consiste em mostrar um dos lados da moeda ao clicar no botão designado para tal função.</p>
...
<p>2 - Utilize o comando <code>git clone https://github.com/victoramos1/cara-ou-coroa</code> caso tenha o Git instalado no computador, ou faça o download do arquivo .zip diretamente do GitHub e descompacte em um local.</p>
